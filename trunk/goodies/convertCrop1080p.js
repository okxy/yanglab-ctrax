...
var FIRST_FRAME = 20;          // use non-zero value to skip frames from the
...
function convert(dir, f) {
  ...
  app.video.addFilter("crop","left=420","right=440","top=20","bottom=0");
  app.video.addFilter("mpresize","w=320","h=320","algo=0");
